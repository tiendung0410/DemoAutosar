...
static const Dio_ChannelCfgType kChannels[] = {
  ...
  /* ChannelId 2: Led1     */ { "gpiochip0", 31, DIO_DIRECTION_OUT },  /* ví dụ P9_13m  */
};

/* Port0 gom 3 line ở trên theo thứ tự bit [2:0] = {Led1, Button2, Button1} */
static const unsigned int kPort0_Offsets[] = { 60, 48, 21 };
static const Dio_PortCfgType kPorts[] = {
  { "gpiochip0", kPort0_Offsets, 3 }  /* chú ý: Led1 ở chip1 trong ví dụ này -> nếu trộn chip, tách ra 2 port là thực tế hơn */
};

/* ChannelGroup ví dụ: nhóm 2 button (bit0..1) trên Port0 */
static const Dio_ChannelGroupType kGroups[] = {
  { .mask = 0x3u, .offset = 0u, .port = 0u },
};
